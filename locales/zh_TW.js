export default {
  ...
  policy_1_title: '一、適用範圍',
  policy_1_content:
    '隱私權政策內容，包括本服務如何處理在您使用服務時收集到的個人識別資料。隱私權政策及個人資料保護聲明適用於中華民國（台灣）地區及本服務提供之範圍內；本服務以外的相關連結網站及非本服務所委託或參與管理的人員，不適用之。',
  policy_2_title: '二、個人資料蒐集目的',
  policy_2_content:
    '下列代號係參照法務部公告之「個人資料保護法之特定目的及個人資料之類別」，代號及項目名稱嗣後如經法務部公告變更，亦隨同變更之：「040行銷」、「081個人資料之合法交易業務」、「090消費者、客戶管理與服務」、「135資（通）訊服務」、「136資（通）訊與資料庫管理」、「148網路購物及其他電子商務服務」、「157調查、統計與研究分析」。',
  policy_3_title: '三、個人資料蒐集類別',
  policy_3_content_1:
    'C001辨識個人者。如：姓名、網路平臺申請之帳號、相片、電子郵遞地址、提供網路身分認證或申辦查詢服務之紀錄及其他任何可辨識資料本人者等。',
  policy_3_content_2:
    'C036生活格調。如：使用消費品之種類及服務之細節、個人或家庭之消費模式等。',
  policy_3_content_3: 'C093財務交易。如：收付金額、支付方式、往來紀錄等。',
  policy_4_title: '四、個人資料之蒐集、處理及利用方式',
  policy_4_content_1:
    '個人資料之蒐集期間為您使用本服務所提供之各項功能服務起，至您自行申請停止之日止；或是本服務各項活動辦法揭載之使用到期日止。但若法令另有規定者，依其規定。',
  policy_4_content_2:
    '當您本服務之APP、網站、或是各項活動服務時，我們將視該服務功能性質，請您提供必要的個人資料，並在特定目的範圍內處理及利用您的個人資料；非經您書面同意，本服務不會將個人資料用於其他用途，且本服務不會也不可能基於任何目的而與任何第三人分享使用您未分離加密的個人資料。',
  policy_4_content_3:
    '本服務在您使用互動性功能（包括但不限於雲端備份、服務信箱、問卷調查）時，會保留您所主動提供的姓名、電子郵件地址、聯絡方式、附檔及使用時間等，並且會不定時清除這些資料。',
  policy_4_content_4:
    '為評估與監測各頁面的流量以確保服務不中斷、提供精確的服務及提供更好的使用者體驗，本服務可能會透過Google或相關服務提供商所提供的服務依去識別化的方式自動蒐集您App或瀏覽器的「IP位址、URL、點擊紀錄、使用裝置、廣告識別碼、追蹤碼或登入資訊」，並以此進行數據統計和研究。',
  policy_4_content_5:
    '您充分了解當您使用本服務中所提供之台灣電子發票相關功能，即代表您授權本服務得依照您提供之登入資訊（包括但不限於手機條碼、驗證碼、發票號碼及所需相關資訊）存取財政部電子發票應用API提供的資訊；並且您也同意本服務可以儲存該資訊及串接軌跡記錄於本服務伺服器裡，以減少存取財政部電子發票應用API的頻率，避免流量超載導致本服務與財政部電子發票平台的連接中斷。您得隨時依據「個人資料保護法」及本服務之「隱私權政策第五點」之說明，要求刪除於本服務留存之記錄。',
  policy_5_title: '五、當事人權利',
  policy_5_content_1:
    '本服務依據「個人資料保護法」及相關法令要求，提供當事人針對其個人資料行使以下權利：「請求查詢或閱覽」、「製給個人複製本」、「請求補充或更正」、「請求停止蒐集、處理及利用」及「請求刪除」。',
  policy_5_content_2:
    '您可自由選擇是否提供您的個人資料，惟若您拒絕提供相關個人資料，本服務之部分功能將無法進行必要之處理作業，致無法提供相關服務。',
  policy_5_content_3:
    '若您請求查詢、閱覽或製給個人複製本之個人資料為由第三方服務所串接之資料（如：Google相關服務），因非由本服務所保管，或本服務僅能取得去識別化之匿名性統計資料，因此本服務無法提供給您。您也不得請求將您的資料自去識別化分析數據之母體中刪除。',
  policy_5_content_4:
    '您亦可隨時來信至客服信箱 support@linziyou.info ，請求本服務停止蒐集、處理及利用您的個人資料，該請求將自到達至本服務加計合理工作時間後生效，但如您與本服務尚有契約關係或有爭議事件或主管機關或法規有其他要求，本服務可拒絕該請求，或於同意該請求之同時終止與您的契約關係。本服務將於確認您的身分後，依據您所提出的申請，於法定期間內履行上述義務。若您委託他人代為申請者，應另提出可資確認的身分證明，以備查核。',
  policy_6_title: '六、資料之保護',
  policy_6_content_1:
    '本服務之所有記帳資料資料僅儲存在個人裝置（Android），並且非經您的允許，我們不會主動搜集您上傳、備份至Google雲端儲存空間之資料；但會提供您上傳至個人Google雲端儲存空間的功能，以確保手機遺失、更換或不明原因之資料毀損時有復原的機會。',
  policy_6_content_2:
    '使用者透過本服務登入Google帳戶存取Google雲端硬碟內的備份資料時，僅透過呼叫Google提供之API進行登入驗證，其驗證流程於Google相關平台進行，本服務不會儲存其登入資訊及個人資訊。',
  policy_6_content_3:
    '如因業務需要而有必要委託其他單位提供服務時，本服務亦會嚴格要求其遵守保密義務，並且採取必要檢查程序以確定其將確實遵守。',
  policy_6_content_4:
    '本服務採取適當之個人資料保護措施，對於個人資料之處理或利用之權限僅對必要者開放（need-to-know basis）。',
  policy_7_title: '七、隱私權政策之修正',
  policy_7_content:
    '本服務隱私權政策將因應需求隨時進行修正，修正後的條款將刊登於網站及軟體上。本條款最近一次更新時間為：西元 2022 年 12 月 10 日。',
  policy_8_title: '八、聯繫我們',
  policy_8_content:
    '如果您對於隱私權政策及個人資料保護之聲明有任何疑問或建議，請隨時來信至 support@linziyou.info 與我們聯繫。',
  ...
  terms_of_service_4_title: '四、您授與本服務的權利',
  terms_of_service_4_content_1:
    '您充分了解當您使用本服務中所提供之台灣電子發票相關功能，即代表您授權本服務得依照您提供之登入資訊（包括但不限於手機條碼、驗證碼、發票號碼及所需相關資訊）存取財政部電子發票應用API提供的資訊；並且您也同意本服務可以儲存該資訊及串接軌跡記錄於本服務伺服器裡，以減少存取財政部電子發票應用API的頻率，避免流量超載導致本服務與財政部電子發票平台的連接中斷。您得隨時依據「個人資料保護法」及本服務之「隱私權政策第五點」之說明，要求刪除於本服務留存之記錄。',
  terms_of_service_4_content_2:
    '本服務作為您合法授權之代理人身份，透過財政部電子發票應用API取得您的發票資訊，以將發票資訊及明細下載至記帳資料中，但對於所存取內容之正確性不負任何之擔保責任，該內容之正確性應由財政部電子發票平台與第三方廠商負責。',
  terms_of_service_4_content_3:
    '若因財政部電子發票應用API服務中斷或是流量超載而無法存取資料，可能導致本服務所提供之內容不具即時性、最終性與有效性。',
  terms_of_service_5_title: '五、服務條款之修正',
  terms_of_service_5_content:
    '本服務條款將因應需求隨時進行修正，修正後的條款將刊登於網站及軟體上。本條款最近一次更新時間為：西元 2022 年 12 月 10 日。',
  terms_of_service_6_title: '六、聯繫我們',
